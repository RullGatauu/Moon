...
let handler = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    //conn.sendHydrated(m.chat, text.trim(), conn.getName(conn.user.jid), await genProfile(conn, m), 'https://instagram.com/nagatorobot', 'Instagram', null, null, [['Speedtest', _p + 'ping'], ['Owner', _p + 'owner']], m)
...
sourceUrl: 'https://chat.whatsapp.com/Bv0B8hVfoBG6bDGSkoaBz1'
}
  }
})
